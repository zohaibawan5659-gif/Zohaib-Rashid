...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const tributeCard = document.getElementById('father-tribute-card');
    ...
    if (tributeCard) tributeCard.addEventListener('click', openModal);

    if (closeChatBtn) closeChatBtn.addEventListener('click', () => {
        chatModal.classList.remove('active');
    });

    // Close modal when clicking outside chat window
